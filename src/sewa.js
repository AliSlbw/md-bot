...
const expiredCheck = (barz, _dir) => {
    setInterval(() => {
        ...
        if (position !== null) {
            ...
            barz.sendMessage(_dir[position].id, { text: `Masa sewa di grup ini telah habis, bot otomatis keluar!` })
            .then( res => {
              barz.groupLeave(_dir[position].id)
